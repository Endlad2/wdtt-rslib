...
static eventOutputEnabled: LazyLock<bool> = LazyLock::new(|| std::env::var("WDTT_EVENTS").as_deref()==Ok("1"));
pub fn emitEvent(t:eventType,payload:Value){if *eventOutputEnabled { println!("__WDTT_EVENT__|{t}|{payload}"); }}
